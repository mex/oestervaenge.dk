...
Gem::Specification.new do |spec|
  ...
  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r{^(assets|_layouts|_includes|LICENSE|README|feed|404)}i) }
  ...
  spec.add_runtime_dependency "jekyll-target-blank", ">= 2.0.2"
